' mail.croche.store Secure Email Setup.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "mail.croche.store"		 					' This is the address for the mail server
strOutServerAddress	   = "mail.croche.store"		 					' This is the address for the mail server
...
strAccount			   = "brunocassiano"							' Mail account to connect as
