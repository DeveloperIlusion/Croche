...
<div class="container mt-5 mb-5">
    <?= Formulario::titulo('Blogs'); ?>
    <table id="tblListaBlogs" class="table table-dark table-striped table-hover table-borderless crudLogin-table mt-4 table-responsive">
        <thead>
            <tr>
...
<?= Formulario::getDataTables("tblListaBlogs") ?>
